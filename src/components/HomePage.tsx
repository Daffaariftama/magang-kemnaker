...
const HomePage = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-8 bg-white rounded-2xl shadow-lg border border-gray-200">
          ...
          <div className="text-red-600 text-xl font-bold mb-4">Terjadi Kesalahan</div>
          <p className="text-gray-600 mb-6">
            {error}
          </p>
          <button 
            onClick={() => window.location.reload()}
            className="bg-primary-900 text-white px-8 py-3 rounded-lg hover:bg-primary-800 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-all shadow-md font-semibold"
          >
            Coba Lagi
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <RunningMessage />
      {/* Header Section */}
      <header className="relative bg-gradient-to-r from-primary-900 via-primary-800 to-purple-900 text-white overflow-hidden">
        {/* Background Pattern */}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              ...
              <div className="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-white/30">
                ...
                <span className="text-sm font-medium text-white/90">
                  {statsLoading ? (
                    ...
                    `✨ ${stats ? formatNumber(stats["Jumlah Lowongan"]) : '1.450'}+ Lowongan Magang Tersedia`
                  )}
                </span>
              </div>
              ...
              <p className="text-xl md:text-2xl text-primary-100 mb-8 max-w-3xl mx-auto leading-relaxed">
                🚀 Mulai perjalanan karirmu dengan pengalaman magang berkualitas dari perusahaan ternama di seluruh Indonesia
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-8">
                ...
                <div className="text-center bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                  ...
                  <div className="text-primary-100 text-sm">Lowongan Aktif</div>
                </div>
                ...
                <div className="text-center bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                  <div className="text-3xl font-bold text-white mb-2">
                    {statsLoading ? (
                      ...
                      stats ? formatNumber(stats["Jumlah Perusahaan"]) : '1.003'
                    )}
                  </div>
                  <div className="text-primary-100 text-sm">Perusahaan</div>
                </div>
                ...
                <div className="text-center bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                  <div className="text-3xl font-bold text-white mb-2">
                    {statsLoading ? (
                      ...
                      stats ? formatNumber(stats["Jumlah Pendaftar Magang"]) : '157.837'
                    )}
                  </div>
                  <div className="text-primary-100 text-sm">Pendaftar</div>
                </div>
                ...
                <div className="text-center bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                  <div className="text-3xl font-bold text-white mb-2">
                    {statsLoading ? (
                      ...
                      stats ? formatNumber(stats["Jumlah Peserta Magang"]) : '0'
                    )}
                  </div>
                  <div className="text-primary-100 text-sm">Peserta Magang</div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <button className="border-2 border-white/30 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-900 transition-all duration-300 backdrop-blur-sm">
      ...
      {/* Filter Section */}
      <section id="filter-section" className="container mx-auto px-4 -mt-8 relative z-20">
        <FilterBar 
          filters={filters} 
      ...
      <div className="container mx-auto px-4 py-8">
              ...
              <div className="flex-1">
                <div className="flex items-center mb-2">
                  ...
                  <p className="text-gray-700 text-lg">
                    Menampilkan <strong className="text-primary-900">{pagination.from}-{pagination.to}</strong> dari{' '}
                    <strong className="text-primary-900">{pagination.total}</strong> lowongan magang
                  </p>
                </div>
        ...
        {/* Loading State */}
        {fetchProgress.isFetchingAll ? (
          <Loading message={`📥 Mengambil data halaman ${fetchProgress.current} dari ${fetchProgress.total}...`} />
        ) : loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              {jobs.length > 0 ? (
                ...
                <div className="col-span-3 text-center py-16 card">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Tidak ada lowongan yang sesuai</h3>
                  <p className="text-gray-500 max-w-md mx-auto mb-6">
                    Coba ubah kata kunci pencarian atau filter untuk menemukan lebih banyak lowongan magang.
                  </p>
                  <button 
                    onClick={() => updateFilters({ programStudi: '', jabatan: '', provinsi: '32' })}
